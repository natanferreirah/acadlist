...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $stmt->bindValue(':id_aluno', $id);
        ...
        $_SESSION['erro_excluir'] = "<p style='color: red; font-weight:600; text-align: center;'>Erro  </p>";
        header("location: ../alunocrud.php");
        exit();
    }
} else {
    $_SESSION['erro_excluir'] = "<p style='color: red; font-weight:600; text-align: center;'>ID do aluno não fornecido.</p>";
    header("location: ../alunocrud.php");
    exit();
}
